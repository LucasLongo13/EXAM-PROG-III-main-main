<script lang="ts">
    let { marcaModel } = $props();
    let id = $props.id();
</script>

{#if marcaModel.editDialog}
    <div
    ...
    >
        <div class="bg-white rounded-md p-4 w-96">
            <form onsubmit={(e) => marcaModel.editMarca(marcaModel.marca.id, e)}>
                <h2 class="text-lg font-bold">Editar Marca</h2>
                <hr />
                ...
                <div class="p-2 flex flex-col">
                    ...
                    <input
                        ...
                        id={`description-${id}`}
                        name="description"
                        value={marcaModel.marca.description}
                    />
                </div>
                ...
                <div class="p-2 flex justify-end gap-2 mt-3">
                    <button
                        ...
                        onclick={() => (marcaModel.editDialog = false)}
                    >
                        Cancelar
                    </button>
                    <button
